...
#ifndef REGION_COMMON_RX_WINDOW_SYMBOL_MARGIN
#define REGION_COMMON_RX_WINDOW_SYMBOL_MARGIN    2U
#endif

#ifndef REGION_COMMON_RX_EARLY_OPEN_MS
#define REGION_COMMON_RX_EARLY_OPEN_MS           2
#endif
...
{
    uint32_t minSymbolsWithMargin = ( uint32_t )minRxSymbols + REGION_COMMON_RX_WINDOW_SYMBOL_MARGIN;

    *windowTimeoutInSymbols = MAX( DIV_CEIL( ( ( 2 * minRxSymbols - 8 ) * tSymbolInUs + 2 * ( rxErrorInMs * 1000 ) ),  tSymbolInUs ), minSymbolsWithMargin ); // Computed number of symbols
    *windowOffsetInMs = ( int32_t )DIV_CEIL( ( int32_t )( 4 * tSymbolInUs ) -
                                               ( int32_t )DIV_CEIL( ( *windowTimeoutInSymbols * tSymbolInUs ), 2 ) -
                                               ( int32_t )( wakeUpTimeInMs * 1000 ), 1000 );
    *windowOffsetInMs -= REGION_COMMON_RX_EARLY_OPEN_MS;
}
