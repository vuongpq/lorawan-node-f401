 ...
 */
#define STATIC_DEVICE_EUI                                  COMMISSIONING_STATIC_DEVICE_EUI

/*!
 * end-device IEEE EUI (big endian)
 */
#define LORAWAN_DEVICE_EUI                                 COMMISSIONING_DEVICE_EUI

/*!
 * App/Join server IEEE EUI (big endian)
 */
#define LORAWAN_JOIN_EUI                                   COMMISSIONING_JOIN_EUI
...
#define SOFT_SE_KEY_LIST                                                                                            \
    {                                                                                                               \
        {                                                                                                           \
             ...
             */                                                                                                     \
            .KeyID    = APP_KEY,                                                                                    \
            .KeyValue = COMMISSIONING_APP_KEY,                                                                      \
        },                                                                                                          \
        {                                                                                                           \
            /*!                                                                                                     \
             * Network root key                                                                                     \
